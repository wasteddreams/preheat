...
1. **Check documentation:** [Documentation Index](README.md)
...
| Previous | Up | Next |
|----------|----|----- |
| [← API Reference](api-reference.md) | [Documentation Index](README.md) | [Examples →](examples/) |
